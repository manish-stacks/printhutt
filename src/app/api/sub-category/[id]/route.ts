...
export async function PUT(
  ...
  try {
    ...
    const updates = {
      ...
      description:
        getStringValue("description") || existingCategory.description,
      metaKeywords:
        getStringValue("metaKeywords") || existingCategory.metaKeywords,
      metaTitle: getStringValue("metaTitle") || existingCategory.metaTitle,
      metaDescription:
        getStringValue("metaDescription") || existingCategory.metaDescription,
      parentCategory:
        getStringValue("parentCategory") || existingCategory.parentCategory,
