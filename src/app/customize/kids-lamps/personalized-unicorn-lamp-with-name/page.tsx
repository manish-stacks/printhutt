...
export default function Page() {
    ...
    useEffect(() => {
        (async () => {
            try {
                const fetchedProduct = await get_product_by_id("6796394853a2fda27c09d3cc");
    ...
    useEffect(() => {
        ...
        const canvas1 = canvasRef.current && initializeCanvas(canvasRef.current, names.name1 || 'First Name', 30, 30);
                        ...
                        <div className="relative rounded-lg">
                            <div id="preview-section" className="relative rounded-lg p-2 backdrop-blur-sm border border-white/10">
                                <div className="img-box relative">
                                    <img src="https://s3.ap-south-1.amazonaws.com/printhutt.dev.bucket/others/product/3.1_ptw7cq_fib7r2.jpg"
                                        alt="Preview"
                                        className="w-full h-full object-cover rounded-lg"
                                        crossOrigin="anonymous"
                                    />
                                    <div className="text-box absolute top-[72%] left-[48%] transform -translate-x-1/2 -translate-y-1/2 text-center">
                                        <canvas ref={canvasRef} width="270" height="100" className="w-full h-full"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
