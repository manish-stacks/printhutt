...
export default function Page() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const fetchedProduct = await get_product_by_id("67935fd4244596deb440777c");
            ...
            <div className="relative rounded-lg">
              <div id="preview-section" className="relative rounded-lg p-2 backdrop-blur-sm border border-white/10">
                <div className="img-box relative">
                  <img src="https://s3.ap-south-1.amazonaws.com/printhutt.dev.bucket/others/product/1.1_zghalb_vllmcr.jpg"
                    alt="Preview"
