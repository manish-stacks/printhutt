...
export default function Page() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const fetchedProduct = await get_product_by_id("67964fe653a2fda27c09d6ca");
              ...
              <div id="preview-section" className="relative rounded-lg p-2 backdrop-blur-sm border border-white/10">
                <div className="img-box relative">
                  <Image
                    width={800}
                    height={800}
                    src="https://s3.ap-south-1.amazonaws.com/printhutt.dev.bucket/others/product/6.1_y3veyw_b1vgfb.jpg"
                    alt="Preview"
