...
export default function Page() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const fetchedProduct = await get_product_by_id("679654e45ab5c7966823e10f");
            ...
            <div className="relative rounded-lg">
              <div id="preview-section" className="relative rounded-lg p-2 backdrop-blur-sm border border-white/10">
                <div className="img-box relative">
                  <img src="https://s3.ap-south-1.amazonaws.com/printhutt.dev.bucket/others/product/9.1_rx9off_cbsjto.jpg"
                    alt="Preview"
