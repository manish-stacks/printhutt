...
export default function Page() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const fetchedProduct = await get_product_by_id("6796580b5ab5c7966823e157");
            ...
            <div className="relative rounded-lg">
              <div id="preview-section" className="relative rounded-lg p-2 backdrop-blur-sm border border-white/10">
                <div className="img-box relative">
                  <img src="https://s3.ap-south-1.amazonaws.com/printhutt.dev.bucket/others/product/10.1_aw5uuk_b0kjam.jpg"
                    alt="Preview"
                    className="w-full h-full object-cover rounded-lg"
                    crossOrigin="anonymous"
                  />
                  <div className="text-box absolute top-[44%] left-[55%] transform -translate-x-1/2 -translate-y-1/2 text-center">
                    <canvas ref={canvasRef} width="320" height="100" className="w-full h-full"></canvas>
                  </div>
                </div>
              </div>
            </div>
