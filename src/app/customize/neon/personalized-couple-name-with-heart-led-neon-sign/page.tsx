...
export default function page() {
  ...
  const neonImage = [
    "https://res.cloudinary.com/dkprths9f/image/upload/v1737980778/1_usrzsh_c_fill_w_600_h_600_ox8s83.jpg",
    "https://res.cloudinary.com/dkprths9f/image/upload/v1737980778/4_eiws2h_c_fill_w_600_h_600_ihtbzv.jpg",
    "https://res.cloudinary.com/dkprths9f/image/upload/v1737980777/2_djgyqt_c_fill_w_600_h_600_jhia2g.jpg",
    "https://res.cloudinary.com/dkprths9f/image/upload/v1737980776/3_mnftyd_c_fill_w_600_h_600_veplrt.jpg",
  ];
            ...
            <div className="relative rounded-lg">
              <div id="preview-section" className="relative rounded-lg p-2 backdrop-blur-sm border border-white/10">
                <div className="img-box relative">
                  ...
                  />
                  <div className="text-box absolute top-[20%] left-[15%]">
                    <canvas ref={canvasRef} width="250" height="140" className="w-full h-full"></canvas>
                  </div>
                  
                  <div className="text-box absolute top-[45%] left-[30%]">
