...
const AcrylicPhotoVideoSlider = () => {
    ...
    const videos = [
        { url: "/product-details/customized-wall-photo-frame-acrylic--acrylic-photo-frame", video: "https://cloudify.printhutt.com/video/WhatsApp_Video_2025-03-01_at_9.11.26_PM_online-video-cutter.com_1_yq8a8p.mp4" },
