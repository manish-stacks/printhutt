...
const BannerTwo = () => {
    return (
        <>
            <section className="section-banner-two my-[50px] max-[1199px]:my-[35px] bg-[url('https://res.cloudinary.com/dxhs6vjab/image/upload/v1743664564/slider/fulgkeyoegyqqvndxzvp.jpg')] min-h-[600px] overflow-hidden bg-no-repeat bg-contain bg-center max-[991px]:max-h-[400px] max-[991px]:min-h-[auto] max-[480px]:hidden">
