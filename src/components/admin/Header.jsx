    ...
    <>
      <header className="flex items-center justify-between bg-white p-4 shadow">
        ...
        <div className="flex items-center">
          <RiMenu3Fill className="text-2xl mr-3" />
          <fieldset className="w-full space-y-1 dark:text-gray-800">
            ...
            <div className="relative">
              <input
                ...
                name="Search"
                placeholder="Search..."
                className="bg-gray-100 w-32 py-2 pe-10 text-sm rounded-md sm:w-auto focus:outline-none dark:bg-gray-100 dark:text-gray-800 focus:dark:bg-gray-50 focus:dark:border-violet-600"
              />
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            <div
              className={`absolute right-0 mt-4 ${isVisible ? "flex" : "hidden"
                } w-64 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark`}
            >
