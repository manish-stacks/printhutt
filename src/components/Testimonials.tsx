            ...
            <div className="w-full px-[12px]">
              ...
              >
                ...
                <div className="testimonials-slider">
                  <Slider {...settings}>
                    <div className="bb-testimonials-inner  mx-auto  max-w-[900px] m-[auto] max-[1399px]:max-w-[800px] ">
                      <div className="flex items-center relative translate-x-[20%] justify-center flex-wrap mx-[-12px] testimonials-row">
                        <div className="  m-auto  min-[768px]:w-[33.33%] w-full px-[12px] max-[767px]:hidden">
                          ...
                          <div className="testimonials-contact h-full flex flex-col justify-end">
                            ...
                            <div className="inner-contact bg-[#fff] mt-[10px] border-[1px] border-solid border-[#eee] p-[20px] rounded-[30px]">
                              <p className="font-Poppins text-[#686e7d] text-[14px] leading-[25px] tracking-[0.03rem] font-light">
                                ...
                                adipisicing elit. Architecto at sint eligendi
                                possimus perspiciatis asperiores reiciendis hic
                    ...
                    <div className="bb-testimonials-inner max-w-[900px] m-[auto] max-[1399px]:max-w-[800px] ">
                      <div className="flex flex-wrap items-center relative translate-x-[20%] justify-center mx-[-12px] testimonials-row">
                        <div className="min-[768px]:w-[33.33%] w-full px-[12px] max-[767px]:hidden">
                          <div className="testimonials-image relative max-[575px]:mb-[20px] max-[575px]:max-w-[200px]">
                            <img
