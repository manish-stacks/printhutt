...
import { sizePresets } from '@/app/product/neon/_data/sizes';
...
export const SizePresets: React.FC<SizePresetsProps> = ({ selectedSize, onSizeSelect }) => {
  return (
      ...
      >
        ...
        <div className="flex justify-between">
          <div>
            ...
            <div className="text-sm text-gray-500">Length: {size.width}</div>
            <div className="text-sm text-gray-500">Height: {size.height}</div>
          </div>
